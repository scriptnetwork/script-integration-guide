...
it('init send parameters', () => {
  try {
    let { chain_id, from, to, SCPTWei, SPAYWei, fee, sequence, async } =
    new SendParameters('scriptnet', '0x0d2fd67d573c8ecb4161510fc00754d64b401f81', '0x0d2fd67d573c8ecb4161510fc00754d64b401f86', 1, 2, 3, 4, true)
    ...
    expect(SCPTWei).toBe('1')
    expect(SPAYWei).toBe('2')
    expect(fee).toBe('3')
